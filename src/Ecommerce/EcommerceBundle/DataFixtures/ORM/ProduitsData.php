...
class ProduitsData extends AbstractFixture implements OrderedFixtureInterface
{
    public function load(ObjectManager $manager)
    {
        ...
        $produit2->setDescription("Meilleur rapport qualité prix appareil");
        $produit2->setDisponible('1');
        $produit2->setImage($this->getReference('media4'));
        $produit2->setNom('Appareil auditif');
        ...
        $produit3->setDescription("Respirez mieux grace a cet appareil hightech");
        $produit3->setDisponible('1');
        $produit3->setImage($this->getReference('media5'));
        $produit3->setNom('Oxygene Ratio');
        ...
        $produit4->setDescription("Veillez sur votre santé grace a ce heart scan");
        $produit4->setDisponible('1');
        $produit4->setImage($this->getReference('media6'));
        $produit4->setNom('Heart Scan');
        ...
        $produit5->setDescription("Meilleur Tensiometre");
        $produit5->setDisponible('1');
        $produit5->setImage($this->getReference('media7'));
        $produit5->setNom('Tensiomètre');
        ...
        $produit6->setDescription("Scanner au top de la technologie");
        $produit6->setDisponible('1');
        $produit6->setImage($this->getReference('media8'));
        $produit6->setNom('Scanner');
